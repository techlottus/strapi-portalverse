  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        ...
        VERCEL_DEPLOY_HOOK: env.VERCEL_DEPLOY_HOOK5,
        VERCEL_DEPLOY_API_TOKEN: env.VERCEL_DEPLOY_API_TOKEN5,
        VERCEL_DEPLOY_APP_FILTER: env.VERCEL_DEPLOY_APP_FILTER5,
        VERCEL_DEPLOY_TEAM_FILTER: env.VERCEL_DEPLOY_TEAM_FILTER5
      }
    },
  ]
});